...
.box-shadow-aboutusimg{
  -webkit-box-shadow: 0px 23px 0px 0px #007CFB; 
box-shadow: 0px 23px 0px 0px #007CFB;
}
...
background: linear-gradient(0deg, rgba(255,255,255,1) 15%, rgba(0,124,251,1) 37%);
}
.button {
  display: inline-flex;
  height: 40px;
